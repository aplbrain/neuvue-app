...
def construct_proofreading_url(seg_ids, coordinate, points=np.NaN, prefix=settings.NG_CLIENT,return_as='url'):
    ...
    if points.any():
        ...
        return base_state.render_state(return_as=return_as, url_prefix=prefix)

    return pf_state.render_state(
        [None, path_df], return_as=return_as, url_prefix=prefix
    )