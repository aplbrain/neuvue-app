...
class WorkspaceView(LoginRequiredMixin, View):
    ...
    def get(self, request, namespace=None, **kwargs):
        ...
        if application_filename in settings.STATIC_NG_FILES:
            return redirect(f'/static/workspace/{application_filename}', content_type='application/javascript')
        ...
        if not task_df:
            ...
            context['ng_state'] = construct_proofreading_url(task_df, points, return_as='json')
