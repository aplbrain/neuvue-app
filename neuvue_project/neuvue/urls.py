...
urlpatterns = [
    ...
    path(
        "dashboard/namespace/<str:namespace>/group/<str:group>",
        DashboardNamespaceView.as_view(),
        name="dashboard",
    ),
    path(
        "dashboard/username/<str:username>",
        DashboardUserView.as_view(),
        name="dashboard",
    ),
    path(
        "dashboard/username/<str:username>/<str:filter>",
        DashboardUserView.as_view(),
        name="dashboard",
    ),
